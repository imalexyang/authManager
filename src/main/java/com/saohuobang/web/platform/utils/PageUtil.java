...
public class PageUtil{
	...
	* @throws
	...
	public static void buildGrid(Page pagebean) {
		int pageNo=pagebean.getPageNo();//当前页
		int pageCount=pagebean.getTotalPage();//总页数
...
//         "     return false;"+
		...
		"  function topage(flag){"+
			...
			"}else if(flag==2){form.action='"+nextPage+"';}"+//下一页
		 	"form.submit(); "+
